...
void MainProcess()
{
	...
	//gotoxy(35, 10);
	cout<<("1. Test Mode");       //Display the menu
	//gotoxy(35, 11);
	...
	char *str)
{
	...
	while (!kbhit())
	{
		if (*InputCount > 0)
		{
			...
			TimeStart = clock();
			//gotoxy(45, 19);
			cout<<("%10.2f seconds", TimeUsed);
			//gotoxy(45, 20);
			cout<<("%10.2f %%", Accuracy);
			//gotoxy(45, 21);
			cout<<("%10.2f wpm", Speed);
			//gotoxy(45, 22);
			cout<<("%10d letters", WrongInput);
			//gotoxy(45, 23);
			cout<<("%10d letters", *InputCount);
			//gotoxy(*x, *y);
...
void Report(int *InputCount, int *CorrectInputCount)
{
	...
	//gotoxy(20, 8);
	cout<<("Time Used       : %10.2f seconds", TimeUsed);
	//gotoxy(20, 10);
	cout<<("Character Typed : %10d letters", *InputCount);
	//gotoxy(20, 12);
	cout<<("Wrong Input     : %10d letters", WrongInput);
	//gotoxy(20, 14);
	cout<<("Accuracy        : %10.2f %%", Accuracy);
	//gotoxy(20, 16);
	cout<<("Speed           : %10.2f wpm (words per minute)", Speed);
	//gotoxy(26, 25);
...
void TrainInitial()
{
	...
	//gotoxy(28, 12);
	cout<<("1. I want to train single letters.");
	//gotoxy(28, 14);
	cout<<("2. I want to train words.");
	//gotoxy(28, 16);
	cout<<("Please press either 1 , 2 or ESC : ");
...
void TrainLetter()
{
	...
	//gotoxy(1, 25);
	cout<<("Press any key when ready.");	//wait for the user to press
	getch();				//any key.
}
...
void PrintWord(char *Word)
{
	...
	if (FilePointer == NULL)
	{
		cout<<("Cannot open the file 'words.txt'."
...
void TrainReport(int *CorrectInputCount, int *InputCount)
{
	...
	//Display the report
	//gotoxy(20, 8);
	cout<<("Time used       : %10.2f seconds per letter.",
		(float)TimeUsed / *CorrectInputCount);

	//gotoxy(20, 10);
	cout<<("Character Typed : %10d letters", *InputCount);
	//gotoxy(20, 12);
	cout<<("WrongInput      : %10d letters", WrongInput);
	//gotoxy(20, 14);
	cout<<("Accuracy        : %10.2f %%", Accuracy);
	//gotoxy(20, 16);
	cout<<("Speed           : %10.2f wpm (words per minute)", Speed);
	...
	cout<<("Press any key (except ESC) to exit"); //wait for the user to press
